/* @ts-self-types="./hamsterball.d.ts" */

/**
 * @param {boolean} enabled
 */
export function configure_guest_memory_metrics(enabled) {
 ...
 */
export function mount_file(path, data) {
    const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.mount_file(ptr0, len0, ptr1, len1);
}
 ...
 * @param {number} value
 */
export function seed_registry_dword(root, subkey, name, value) {
 ...
 * @param {string} path
 */
export function set_current_dir(path) {
    const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_current_dir(ptr0, len0);
}

/**
 * @param {string} spec
 */
export function set_trace(spec) {
    const ptr0 = passStringToWasm0(spec, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_trace(ptr0, len0);
}
function __wbg_get_imports(memory) {
    const import0 = {
        ...
        __wbg_send_to_host_552047471278592c: function(arg0, arg1, arg2, arg3) {
            send_to_host(getStringFromWasm0(arg0, arg1), arg2, arg3 >>> 0);
        },
        ...
        memory: memory || new WebAssembly.Memory({initial:50,maximum:8192,shared:true}),
    };
    return {
        __proto__: null,
        "./hamsterball_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hamsterball_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
